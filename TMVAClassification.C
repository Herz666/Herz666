...
int TMVAClassification( TString myMethodList = "" )
{
   ...
   std::unique_ptr<TFile> input{TFile::Open("f_data.root", "CACHEREAD")};
   ...
   dataloader->AddVariable( "Mz", "masse_z",'D' );
   dataloader->AddVariable( "cos_theta_z","cosinus ", "", 'D' );
   dataloader->AddVariable( "cos_theta_star", "cosinus_star", 'D' );
   dataloader->AddVariable( "m_rec","recoil_mass", 'D' );
